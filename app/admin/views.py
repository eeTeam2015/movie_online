...
from app.admin.forms import PwdForm, AuthForm, RoleForm, AdminForm
from app.models import Admin, Tag, Movie, Preview, User, Comment, Moviecol
from app.models import Oplog, Adminlog, Userlog, Auth, Role
...
# 管理员日志列表
@admin.route("/adminloginlog_list/list/<int:page>/", methods=["GET"])
@admin_login_req
@admin_auth
